...
namespace Cash8
{
    class KitchenPrinter
    {
        ...
        public async Task<bool> PrintReceiptToThermalPrinterAsync(ReceiptData receiptData, string selectedPrinter = "THERMAL Receipt Printer")
        {
            try
            {
            ...
            {
                // Логируем ошибку, но не показываем MessageBox здесь
